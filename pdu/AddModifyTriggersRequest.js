...
class PduAddModifyTriggerRequest {
    constructor({
        ...
        this.pduTypeExtension = new ElementPduTypeExtension("ADD-MODIFY-TRIGGER-REQUEST-RESPONSE");
    ...
    static fromData(data) {
        ...
        if(pduTypeExtension != "ADD-MODIFY-TRIGGER-REQUEST-RESPONSE"){
        ...
        const reportTypeValue = binaryString.slice(8, 10);
        ...
        const type5Elements = parseType5Elements(binaryString.slice(10));

        return new PduAddModifyTriggerRequest({
            requestResponse,
    ...
    toData(){
        ...
        const binaryString = pduType + pduTypeExtension + requestResponse + acknowledgementRequest + reportType + type5Elements;
        const hexString = binaryToHex(binaryString);

        return hexString;
    }
}
module.exports = PduAddModifyTriggerRequest;