...
class PduRemoveTriggerRequest {
    ...
    static fromData(data) {
        ...
        const type5Elements = parseType5Elements(binaryString.slice(8));

        return new PduRemoveTriggerRequest({
            requestResponse,
    ...
    toData(){
        ...
        const binaryString = pduType + pduTypeExtension + requestResponse + acknowledgementRequest + type5Elements;
        const hexString = binaryToHex(binaryString);

        return hexString;
    }
}
module.exports = PduRemoveTriggerRequest;