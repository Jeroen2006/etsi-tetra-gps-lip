...
class PduReportBasicLocationParametersResponse {
    constructor({
        resultCode = "Success",
        globalEnable = false,
    ...
    static fromData(data) {
        ...
        return new PduReportBasicLocationParametersResponse({
            pduType,
            pduTypeExtension,
            requestResponse,
            resultCode,
...
module.exports = PduReportBasicLocationParametersResponse;